...
app.use(
    cors({
        origin: [
            "http://localhost:3000",
            "http://localhost:3001",
            "https://bob-ui-v-2-narayanas-projects.vercel.app",
            "https://bob-ui-v-2-git-main-narayanas-projects.vercel.app",
            "https://bob-ui-v-2.vercel.app",
            "https://bob-staging-1.vercel.app",
            "https://bob-staging-1-narayanas-projects.vercel.app",
            "https://bob-staging-1-git-main-narayanas-projects.vercel.app"
        ],
...
app.post("/add-shared-user", async (req, res) => {
    try {
        ...
        res
            .status(500)
            .json({ error: "Error adding shared user", message: error.message });
    }
});
...
app.post("/delete-shared-user", async (req, res) => {
    try {
        ...
        res
            .status(500)
            .json({ error: "Error deleting shared user", message: error.message });
    }
});
